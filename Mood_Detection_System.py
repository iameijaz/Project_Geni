...
'''
THIS SAMPLE CODE IS FUNCTIONAL FOR A LAPTOP CAMERA(1ST STAGE), BUT FOR OUR PROJECT, 
WE PLAN TO USE A ESP-32 CAM (OR SIMILAR) WHICH IS A CHEAP BUT EFFECTIVE MODULE FOR 
IMPLEMENTING COMPUTER VISION RELATED APPLICATIONS

SO THE LOGIC AND FUNCTIONALITY WILL BE ALMOST SIMILAR
'''
